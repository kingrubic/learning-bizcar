...
export default async function CoursesPage({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return (
    <main>
      ...
      <p className="muted">Khoá mới nhận bản sao 19 bài từ khoá nguồn: cùng nội dung tương tác, bài làm học viên không đi theo. Sau đó tạo lớp cho khoá mới ở mục Lớp học.</p>
