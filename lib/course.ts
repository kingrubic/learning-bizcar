...
export const LESSONS: LessonMeta[] = [
  ...
  { number: 22, code: "22", title: "Brand Shell / ILS", framework: "ILS", summary: "Brand Shell. Identity, Language và Signals để doanh nghiệp được nhận ra, hiểu đúng và được kiểm chứng tại Encounter Point.", group: "BRAND SHELL", hasReport: false, storageKey: "bmdo_k03_buoi22_brand_shell_ils_v1", schemaVersion: "1", contentVersion: "2026.09" },
  { number: 23, code: "23", title: "Environment & Road / CTR", framework: "CTR", summary: "Environment & Road. Climate, Terrain và Road giúp đọc khí hậu, hiểu địa hình và chọn con đường phù hợp với MyBizCar.", group: "ENVIRONMENT", hasReport: false, storageKey: "bmdo_k03_buoi23_environment_road_ctr_v1", schemaVersion: "1", contentVersion: "2026.09" },
  { number: 24, code: "24", title: "BizCar Fuel / 6FT", framework: "6FT", summary: "BizCar Fuel. Sáu nguồn nhiên liệu — tri thức, nhân tài, thông tin, thương hiệu, tài chính và quan hệ tin cậy — được tiếp cận, huy động và chuyển hóa thành lực đẩy.", group: "FUEL", hasReport: false, storageKey: "bmdo_k03_buoi24_bizcar_fuel_6ft_v1", schemaVersion: "1", contentVersion: "2026.09" },
...
export const WORKBOOK: Record<number, WorkbookField[]> = {
  ...
  22: [
    { path: "profile.company", label: "Doanh nghiệp" },
    { path: "profile.name", label: "Người thiết kế" },
    { path: "activate.who", label: "Đối tượng cần nhận ra" },
    { path: "activate.gap", label: "Khoảng lệch nhận diện" },
    { path: "identity.statement", label: "Identity" },
    { path: "identity.knownFor", label: "Muốn được biết đến vì" },
    { path: "language.message", label: "Thông điệp" },
    { path: "language.promise", label: "Lời hứa" },
    { path: "signals.priority", label: "Tín hiệu ưu tiên" },
    { path: "lens.key", label: "Góp ý then chốt" },
    { path: "improve.0", label: "Cải tiến 1" },
    { path: "improve.1", label: "Cải tiến 2" },
    { path: "improve.2", label: "Cải tiến 3" },
    { path: "extract.0", label: "Bài học 1" },
  ...
  23: [
    { path: "profile.company", label: "Doanh nghiệp" },
    { path: "profile.name", label: "Người thiết kế" },
    { path: "activate.priority", label: "Biến động ưu tiên" },
    { path: "climate.priority", label: "Climate ưu tiên" },
    { path: "climate.action", label: "Hành động thích ứng" },
    { path: "terrain.obstacle", label: "Trở ngại địa hình" },
    { path: "terrain.advantage", label: "Thuận lợi địa hình" },
    { path: "road.destination", label: "Đích đến" },
    { path: "road.statement", label: "Con đường đã chọn" },
    { path: "lens.assumption", label: "Giả định cần kiểm" },
    { path: "improve.0", label: "Cải tiến 1" },
    { path: "improve.1", label: "Cải tiến 2" },
    { path: "improve.2", label: "Cải tiến 3" },
    { path: "extract.0", label: "Bài học 1" },
    { path: "extract.1", label: "Bài học 2" },
    { path: "extract.2", label: "Bài học 3" },
    { path: "resolve.choice", label: "Lựa chọn 7 ngày" },
    { path: "resolve.person", label: "Người theo dõi" },
    { path: "resolve.evidence", label: "Bằng chứng" },
  ],
  24: [
    { path: "profile.company", label: "Doanh nghiệp" },
    { path: "profile.name", label: "Người thiết kế" },
    { path: "goal.target", label: "Mục tiêu 90 ngày" },
    { path: "goal.result", label: "Kết quả cần tạo" },
    { path: "profile.lockReason", label: "Nguồn nhiên liệu khóa" },
    { path: "lens.unconverted", label: "Nguồn chưa chuyển hóa" },
    { path: "improve.0", label: "Cải tiến 1" },
    { path: "improve.1", label: "Cải tiến 2" },
    { path: "improve.2", label: "Cải tiến 3" },
    { path: "improve.mechanism", label: "Cơ chế chuyển hóa" },
    { path: "extract.0", label: "Bài học 1" },
    { path: "extract.1", label: "Bài học 2" },
    { path: "extract.2", label: "Bài học 3" },
    { path: "resolve.fuel", label: "Nguồn sẽ huy động" },
    { path: "resolve.activate", label: "Hành động kích hoạt" },
    { path: "resolve.owner", label: "Chủ sở hữu" },
    { path: "resolve.evidence", label: "Bằng chứng" },
  ],
  25: [
    { path: "profile.company", label: "Doanh nghiệp" },
    { path: "profile.name", label: "Người thiết kế" },
    { path: "situation.context", label: "Tình huống văn hóa" },
    { path: "situation.fact", label: "Hành vi quan sát" },
    { path: "B.learned", label: "Belief đã học" },
    { path: "O.conflict", label: "Xung đột ưu tiên" },
    { path: "mechanism.behavior", label: "Hành vi thay thế" },
    { path: "lens.insight", label: "Nhận định then chốt" },
    { path: "improve.0", label: "Cải tiến 1" },
    { path: "improve.1", label: "Cải tiến 2" },
    { path: "improve.2", label: "Cải tiến 3" },
    { path: "extract.0", label: "Bài học 1" },
    { path: "extract.1", label: "Bài học 2" },
    { path: "extract.2", label: "Bài học 3" },
    { path: "resolve.strengthen", label: "Hành vi cần củng cố" },
    { path: "resolve.decision", label: "Quyết định văn hóa" },
    { path: "resolve.evidence", label: "Bằng chứng" },
  ],
  26: [
    { path: "profile.company", label: "Doanh nghiệp" },
    { path: "profile.name", label: "Người thiết kế" },
    { path: "decision.question", label: "Quyết định đang soi" },
    { path: "decision.goal", label: "Mục tiêu quyết định" },
    { path: "I.conclusion", label: "Diễn giải đã chọn" },
    { path: "C.selected", label: "Phương án đã chọn" },
    { path: "C.tradeoff", label: "Đánh đổi" },
    { path: "O.owner", label: "Người sở hữu hệ quả" },
    { path: "lens.insight", label: "Nhận định then chốt" },
    { path: "improve.0", label: "Cải tiến 1" },
    { path: "improve.1", label: "Cải tiến 2" },
    { path: "improve.2", label: "Cải tiến 3" },
  ...
  27: [
    { path: "profile.company", label: "Doanh nghiệp" },
    { path: "profile.name", label: "Người thiết kế" },
    { path: "situation.context", label: "Tình huống phụ thuộc" },
    { path: "situation.ceoRole", label: "Vai trò CEO đang gánh" },
    { path: "compensation.who", label: "Ai đang bù đắp" },
    { path: "compensation.risk", label: "Rủi ro phụ thuộc" },
    { path: "ceo.stop", label: "Điều CEO cần dừng" },
    { path: "lens.insight", label: "Nhận định then chốt" },
    { path: "improve.0", label: "Cải tiến 1" },
    { path: "improve.1", label: "Cải tiến 2" },
    { path: "improve.2", label: "Cải tiến 3" },
    ...
    { path: "extract.1", label: "Bài học 2" },
    { path: "extract.2", label: "Bài học 3" },
    { path: "resolve.capability", label: "Khả lực chuyển giao" },
    { path: "resolve.action", label: "Thử nghiệm 7 ngày" },
    { path: "resolve.evidence", label: "Bằng chứng" },
  ],
};
...
export const PORTFOLIO: Record<number, { heading: string; paths: WorkbookField[] }> = {
  ...
  22: { heading: "Brand Shell / ILS", paths: WORKBOOK[22] },
  23: { heading: "Environment & Road / CTR", paths: WORKBOOK[23] },
  24: { heading: "BizCar Fuel / 6FT", paths: WORKBOOK[24] },
